...
NOTE: switches tips between dispense steps -> can eliminate this but would need
to rewrite both steps into one .hso file 
...
soloSoft = SoloSoft(
    filename="putida_OD600_step1&3_dispense.hso",
    plateList=[
