...
soloSoft.aspirate(
    position="Position8",
    aspirate_volumes=Plate_96_PlateOne_1833_9600_ConicalBottomStorage().setColumn(1, 10),
    aspirate_shift=[0,0,asp_z_shift],
)
soloSoft.dispense(
    position="Position8",
    dispense_volumes=Plate_96_PlateOne_1833_9600_ConicalBottomStorage().setColumn(2, 10), 
    dispense_shift=[0,0,asp_z_shift],
)
