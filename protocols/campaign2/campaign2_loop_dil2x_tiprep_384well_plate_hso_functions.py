...
blowoff_volume
    ...
    # * Fill first column of culture dilution plate with fresh lb media (do in two steps due to 180uL filter tips)
    for i in range(
        2
    ...
    # * Fill second column of culture dilution plate with fresh lb media (do in two steps due to 180uL filter tips)
    ...
    2
        ...
        soloSoft.aspirate(
            position="Position1",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                media_start_column[k]+2, half_dilution_media_volume
            ),
            aspirate_shift=[0, 0, media_z_shift],
        )
        soloSoft.dispense(
            position="Position7",
            dispense_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+1, half_dilution_media_volume
            ),
            dispense_shift=[0, 0, reservoir_z_shift],
        )
    ...
    for i in range(
        ...
        soloSoft.aspirate(
            position="Position1",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                media_start_column[k] + 3, half_dilution_media_volume
            ),
            aspirate_shift=[0, 0, media_z_shift],
        )
        soloSoft.dispense(
    ...
    # * Fill third column of culture dilution plate with fresh lb media (do in two steps due to 180uL filter tips)
    ...
    2
        ...
        soloSoft.dispense(
            position="Position7",
            dispense_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+2, half_dilution_media_volume
            ),
            dispense_shift=[0, 0, reservoir_z_shift],
        )
    ...
    # * Fill fourth column of culture dilution plate with fresh lb media (do in two steps due to 180uL filter tips)
    ...
    2
        ...
        soloSoft.dispense(
            position="Position7",
            dispense_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+3, half_dilution_media_volume
            ),
            dispense_shift=[0, 0, reservoir_z_shift],
        )
    ...
    # * Make culture 10 fold dilution col 1
    ...
    # * Make culture 10 fold dilution col 2
    for i in range(1, 3):  # all cells dispensed into same cell dilution column
        soloSoft.aspirate(
            position="Position5",
            aspirate_volumes=DeepBlock_96VWR_75870_792_sterile().setColumn(
                culture_column[k]+1, dilution_culture_volume
            ),
            aspirate_shift=[0, 0, 2],
            mix_at_start=True,
            mix_cycles=culture_plate_num_mix,
        ...
        soloSoft.dispense(
            position="Position7",
            dispense_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+1, dilution_culture_volume
            ),
            dispense_shift=[0, 0, reservoir_z_shift],
            mix_at_finish=True,
            mix_cycles=num_mixes,
    ...
    # * Make culture 10 fold dilution col 3
    for i in range(1, 3):  # all cells dispensed into same cell dilution column
        soloSoft.aspirate(
            position="Position5",
            aspirate_volumes=DeepBlock_96VWR_75870_792_sterile().setColumn(
                culture_column[k]+2, dilution_culture_volume
            ),
            aspirate_shift=[0, 0, 2],
            mix_at_start=True,
            mix_cycles=culture_plate_num_mix,
        ...
        soloSoft.dispense(
            position="Position7",
            dispense_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+2, dilution_culture_volume
            ),
            dispense_shift=[0, 0, reservoir_z_shift],
            mix_at_finish=True,
            mix_cycles=num_mixes,
    ...
    # * Make culture 10 fold dilution col 4
    for i in range(1, 3):  # all cells dispensed into same cell dilution column
        soloSoft.aspirate(
            position="Position5",
            aspirate_volumes=DeepBlock_96VWR_75870_792_sterile().setColumn(
                culture_column[k]+3, dilution_culture_volume
            ),
            aspirate_shift=[0, 0, 2],
            mix_at_start=True,
            mix_cycles=culture_plate_num_mix,
        ...
        soloSoft.dispense(
            position="Position7",
            dispense_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+3, dilution_culture_volume
            ),
            dispense_shift=[0, 0, reservoir_z_shift],
            mix_at_finish=True,
            mix_cycles=num_mixes,
    ...
    # * Separate big mix step to ensure cell diluton column 1 is well mixed  # added for 09/07/21
    soloSoft.aspirate(
        position="Position7",
        aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
            culture_dil_column[k], dilution_culture_volume
    ...
    # * Separate big mix step to ensure cell diluton column 2 is well mixed  # added for 09/07/21
    soloSoft.aspirate(
        position="Position7",
        aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
            culture_dil_column[k]+1, dilution_culture_volume
    ...
    # * Separate big mix step to ensure cell diluton column 3 is well mixed  # added for 09/07/21
    soloSoft.aspirate(
        position="Position7",
        aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
            culture_dil_column[k]+2, dilution_culture_volume
    ...
    # * Separate big mix step to ensure cell diluton column 4 is well mixed  # added for 09/07/21
    soloSoft.aspirate(
        position="Position7",
        aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
            culture_dil_column[k]+3, dilution_culture_volume
...
# * Adds diluted cells to assay plate from columns 1 and 2
def generate_add_diluted_cells_to_assay_first_half_hso(directory_path,
filename,
media_start_column,
media_z_shift,
flat_bottom_z_shift,
...
k
    ...
    for i in range(start_col, end_col+1):  # trying a different method of cell dispensing (09/07/21)
        ...
        soloSoft.aspirate(  # well in second quarter
            position="Position7",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+1, culture_transfer_volume_s1
            ),
            aspirate_shift=[
                0,
                0,
...
# * Adds diluted cells to assay plate, draws from cell columns 3 and 4
def generate_add_diluted_cells_to_assay_second_half_hso(directory_path,
filename,
media_start_column,
media_z_shift,
flat_bottom_z_shift,
...
k
    ...
    for i in range(start_col, end_col+1):  # trying a different method of cell dispensing (09/07/21)
        soloSoft.aspirate(  # well in first half
            position="Position7",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+2, culture_transfer_volume_s1
            ),
            aspirate_shift=[
                0,
                0,
        ...
        soloSoft.aspirate(  # well in second quarter
            position="Position7",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                culture_dil_column[k]+3, culture_transfer_volume_s1
            ),
            aspirate_shift=[
                0,
                0,
...
def generate_serial_dlution_treatment_part1_hso(directory_path,
filename,
treatment_dil_half,
media_start_column,
...
num_mixes
    ...
    for i in range(
        ...
        soloSoft.aspirate(  # 120 from first lb media well
            position="Position1",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                media_start_column[k]+2, media_transfer_volume_s2
            ),
            aspirate_shift=[0, 0, media_z_shift],
            # pre_aspirate=blowoff_volume,
        )
        ...
        soloSoft.aspirate(  # 120 from second lb media well
            position="Position1",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                media_start_column[k] + 3, media_transfer_volume_s2
            ),
            aspirate_shift=[0, 0, media_z_shift],
            # pre_aspirate=blowoff_volume,
        )
    ...
    # * Fill column 6 of a generic 96 well plate with 480uL lb media total in two steps
    ...
    for i in range(media_start_column[k], media_start_column[k] + 2):
        soloSoft.aspirate(  # first lb media well
            position="Position1",
            aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                i+2, last_column_transfer_volume_s2
            ),
            aspirate_shift=[0, 0, media_z_shift],
            # pre_aspirate=blowoff_volume,
        )
...
def generate_serial_dlution_treatment_part2_hso(directory_path,
filename,
treatment_dil_half,
media_start_column,
media_transfer_volume_s2,
