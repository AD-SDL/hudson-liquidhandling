...
def generate_campaign1_repeatable(
    ...
    for k in range(len(treatment)):
        ...
        soloSoft = SoloSoft(
            filename=step1_assay_plate_media_first_half_hso_filename,
            plateList=[
        ...
        for i in range(7,13):  # second quarter plate = media from column 2
            soloSoft.aspirate(
                position="Position1",
                aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
        ...
        soloSoft = SoloSoft(
            filename=step1_assay_plate_media_second_half_hso_filename,
            plateList=[
                "DeepBlock.96.VWR-75870-792.sterile",
                "Empty",
                "TipBox.180uL.Axygen-EVF-180-R-S.bluebox",
        ...
        for i in range(19,25):  # fourth quarter plate = media from column 2
            soloSoft.aspirate(
                position="Position1",
                aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                    media_start_column[k] + 1, media_transfer_volume_s1
        ...
        soloSoft = SoloSoft(
            filename=step1_cells_to_assay_second_half_hso_filename,
            plateList=[
                "DeepBlock.96.VWR-75870-792.sterile",
                "Empty",
                "TipBox.180uL.Axygen-EVF-180-R-S.bluebox",
        ...
        soloSoft.getTip("Position3")
        for i in range(7, 13):  # trying a different method of cell dispensing (09/07/21)
            soloSoft.aspirate(  # well in first half
                position="Position7",
                aspirate_volumes=Reservoir_12col_Agilent_201256_100_BATSgroup().setColumn(
                    culture_dil_column[k], culture_transfer_volume_s1
        ...
        soloSoft.getTip("Position3")
        for i in range(6, 0, -1):  # first quarter of plate
        ...
        soloSoft.getTip("Position3")
        for i in range(6, 0, -1):  # second quarter of plate
            # if i == 3:  # switch tips half way through to reduce error  # tested and ok to remove
            #     soloSoft.getTip()
            soloSoft.aspirate(
                position="Position6",
        ...
        for i in range(12, 6, -1):  # third quarter of plate
            # if i == 3:  # switch tips half way through to reduce error  # tested and ok to remove
            #     soloSoft.getTip()
            soloSoft.aspirate(
                position="Position6",
        ...
        soloSoft.getTip("Position3")
        for i in range(12, 6, -1):  # fourth quarter of plate
            # if i == 3:  # switch tips half way through to reduce error  # tested and ok to remove
            #     soloSoft.getTip()
            soloSoft.aspirate(
                position="Position6",
