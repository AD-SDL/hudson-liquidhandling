...
def test_run_ahk(test_instructions_dir_path):
    ...
    hudson01_instruction_dir = os.path.split(
        os.path.dirname(test_instructions_dir_path)
    )[0]
    ...
    if not present_in_log:
        ...
        instruction_txt_files = [
            os.path.join(test_instructions_dir_path, f)
            for f in os.listdir(test_instructions_dir_path)
